...
class Users_admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/Users_admin/index?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/Users_admin/index?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/Users_admin/index';
            $config['first_url'] = base_url() . 'admin/Users_admin/index';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = TRUE;
        $this->Users_model->db->where("level", "admin");
        ...
        $data = array(
            ...
            'start' => $start,
            'konten'=>'admin/users_admin/users_list'
        );
    ...
    public function read($id) 
    {
        ...
        if ($row) {
    		...
    		'alamat' => $row->alamat,
    		'level' => $row->level,
            'konten'=> 'admin/users_admin/users_read'
    	    );
            $this->load->view('admin/container', $data);
        } else {
            $this->session->set_flashdata('message', 'Data tidak ditemukan');
            redirect(site_url('admin/Users_admin'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'konten'=> 'admin/users_admin/users_form'
	   );
        $this->load->view('admin/container', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            ...
            $data = array(
                'button' => 'Simpan',
                'action' => site_url('admin/Users_admin/update_action'),
    ...
    public function word()
    {
        ...
        header("Content-Disposition: attachment;Filename=users_admin.doc");
        ...
        $this->load->view('users_admin/users_doc',$data);
    }
