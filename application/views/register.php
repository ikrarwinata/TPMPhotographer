		...
		<section class="w3l-ecommerce-main">
			...
			<div class="ecom-contenthny py-12">
				<div class="container py-lg-12">
					<h3 class="hny-title mb-0 text-center">Pendaftaran <span>Akun</span></h3>
					<p class="text-center">Daftar akun anda agar dapat melakukan booking</p>

					<form action="<?php echo (base_url('Home/register_action')) ?>" method="POST" onsubmit="return validate_register()">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-9 col-md-9 col-sm-9">
									<input type="text" class="form-control" name="nik" id="nik" placeholder="Nomor Tanda Pengenal (Misal KTP / Kartu Pelajar)" value="<?php echo ($id) ?>" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-9 col-md-9 col-sm-9">
									<input type="text" class="form-control" name="username" id="username" placeholder="Username baru" value="<?php echo ($username) ?>" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-4">
									<input type="password" class="form-control" name="password" id="password" placeholder="Password baru" value="<?php echo ($password) ?>" required>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4">
									<input type="password" class="form-control" name="password2" id="password2" placeholder="Konfirmasi Password" value="<?php echo ($password) ?>" required>
								</div>
							</div>
						</div>
